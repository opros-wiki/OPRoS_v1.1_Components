#ifndef _ForceSensorService_REQUIRED_PORT_H
#define _ForceSensorService_REQUIRED_PORT_H
...
/*
 * 
 * ForceSensorService : public RequiredServicePort
 *
 */
class ForceSensorServiceRequired
...
public:
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeRequiredMethod(&ForceSensorServiceRequired::SetParameter,"SetParameter");
        ...
        ptr_method = makeRequiredMethod(&ForceSensorServiceRequired::GetParameter,"GetParameter");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&ForceSensorServiceRequired::GetError,"GetError");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&ForceSensorServiceRequired::Enable,"Enable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&ForceSensorServiceRequired::Disable,"Disable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&ForceSensorServiceRequired::GetSensorValue,"GetSensorValue");
        opros_assert(ptr_method != NULL);
