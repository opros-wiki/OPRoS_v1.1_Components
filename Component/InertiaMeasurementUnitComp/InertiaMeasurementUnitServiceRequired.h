...
protected:
	...
	typedef RequiredMethod< vector<ObjectPosture> > GetSensorValueFuncType;
...
public:
	...
	vector<ObjectPosture> GetSensorValue()
	{
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeRequiredMethod(&InertiaMeasurementUnitServiceRequired::Enable,"Enable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&InertiaMeasurementUnitServiceRequired::Disable,"Disable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&InertiaMeasurementUnitServiceRequired::GetSensorValue,"GetSensorValue");
        opros_assert(ptr_method != NULL);
