...
#ifndef _IInertiaMeasurementUnitService_CLASS_DEF
#define _IInertiaMeasurementUnitService_CLASS_DEF
/*
...
class IInertiaMeasurementUnitService
{
 public:
    ...
    virtual vector<ObjectPosture> GetSensorValue()=0;
 };
#endif
...
protected:
   ...
   typedef ProvidedMethod< vector<ObjectPosture> > GetSensorValueFuncType;
...
public:
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeProvidedMethod(&IInertiaMeasurementUnitService::Enable,pcom,"Enable");
        ...
        ptr_method = makeProvidedMethod(&IInertiaMeasurementUnitService::Disable,pcom,"Disable");
        ...
        ptr_method = makeProvidedMethod(&IInertiaMeasurementUnitService::GetSensorValue,pcom,"GetSensorValue");
