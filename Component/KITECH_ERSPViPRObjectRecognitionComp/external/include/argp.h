...
struct EVOLUTION_EXPORT_ARGP argp_option
{
...
struct EVOLUTION_EXPORT_ARGP argp;			/* fwd declare this type */
struct EVOLUTION_EXPORT_ARGP argp_state;		/* " */
struct EVOLUTION_EXPORT_ARGP argp_child;		/* " */
...
struct EVOLUTION_EXPORT_ARGP argp
{
...
extern EVOLUTION_EXPORT_ARGP error_t argp_parse (__const struct argp *__restrict __argp,
			   int __argc__, char **__restrict __argv__,
...
extern EVOLUTION_EXPORT_ARGP __const char *argp_program_version;
...
/* If defined or set by the user program, it should point to string that is
   ...
   `Report bugs to ADDR.'.  */
extern EVOLUTION_EXPORT_ARGP __const char *argp_program_bug_address;
...
/* If appropriate, print the printf string FMT and following args, preceded
   ...
   message, then exit (1).  */
extern EVOLUTION_EXPORT_ARGP void argp_error (__const struct argp_state *__restrict __state,
