...
#ifndef _IBumperSensorService_CLASS_DEF
#define _IBumperSensorService_CLASS_DEF
/*
...
class IBumperSensorService
{
 public:
    ...
    virtual vector<bool> GetSensorValue()=0;
 };
#endif
 ...
 *
 */
class BumperSensorServiceProvided
	:public ProvidedServicePort, public IBumperSensorService
{
protected:
   ...
   typedef ProvidedMethod< vector<bool> > GetSensorValueFuncType;
...
public:
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeProvidedMethod(&IBumperSensorService::Enable,pcom,"Enable");
        ...
        ptr_method = makeProvidedMethod(&IBumperSensorService::Disable,pcom,"Disable");
        ...
        ptr_method = makeProvidedMethod(&IBumperSensorService::GetSensorValue,pcom,"GetSensorValue");
