#ifndef _ForceTorqueSensorService_REQUIRED_PORT_H
#define _ForceTorqueSensorService_REQUIRED_PORT_H
...
/*
 * 
 * ForceTorqueSensorService : public RequiredServicePort
 *
 */
class ForceTorqueSensorServiceRequired : public RequiredServicePort
{
protected:
	...
	typedef RequiredMethod< vector<ForceTorqueSensorData >> GetSensorValueFuncType;
...
public:
	...
	// Constructor
	//
	ForceTorqueSensorServiceRequired()
	{
	...
	vector<ForceTorqueSensorData> GetSensorValue()
	{
	...
	virtual void setup()
	{
		...
		ptr_method = makeRequiredMethod(&ForceTorqueSensorServiceRequired::SetParameter,"SetParameter");
		opros_assert(ptr_method != NULL);
		addMethod("SetParameter",ptr_method);
		SetParameterFunc = reinterpret_cast<SetParameterFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeRequiredMethod(&ForceTorqueSensorServiceRequired::GetParameter,"GetParameter");
		opros_assert(ptr_method != NULL);
		addMethod("GetParameter",ptr_method);
		GetParameterFunc = reinterpret_cast<GetParameterFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeRequiredMethod(&ForceTorqueSensorServiceRequired::GetError,"GetError");
		opros_assert(ptr_method != NULL);
		addMethod("GetError",ptr_method);
		GetErrorFunc = reinterpret_cast<GetErrorFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeRequiredMethod(&ForceTorqueSensorServiceRequired::Enable,"Enable");
		opros_assert(ptr_method != NULL);
		addMethod("Enable",ptr_method);
		EnableFunc = reinterpret_cast<EnableFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeRequiredMethod(&ForceTorqueSensorServiceRequired::Disable,"Disable");
		opros_assert(ptr_method != NULL);
		addMethod("Disable",ptr_method);
		DisableFunc = reinterpret_cast<DisableFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeRequiredMethod(&ForceTorqueSensorServiceRequired::GetSensorValue,"GetSensorValue");
		opros_assert(ptr_method != NULL);
