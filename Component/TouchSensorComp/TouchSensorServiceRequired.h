 ...
 *
 */
class TouchSensorServiceRequired
...
public:
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeRequiredMethod(&TouchSensorServiceRequired::Enable,"Enable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&TouchSensorServiceRequired::Disable,"Disable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&TouchSensorServiceRequired::GetSensorValue,"GetSensorValue");
        opros_assert(ptr_method != NULL);
