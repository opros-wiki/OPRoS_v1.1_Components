#ifndef _TorqueSensorService_PROVIDED_PORT_H
#define _TorqueSensorService_PROVIDED_PORT_H
...
#ifndef _ITorqueSensorService_CLASS_DEF
#define _ITorqueSensorService_CLASS_DEF
/*
 * ITorqueSensorService
 *
 *  The comonent inherits this class and implements methods. 
 */
class ITorqueSensorService
{
public:
...
/*
 * 
 * TorqueSensorService : public ProvidedServicePort
 *
 */
class TorqueSensorServiceProvided : public ProvidedServicePort, public ITorqueSensorService
{
protected:
	ITorqueSensorService *pcom;
...
public:
	...
	// Constructor
	//
	TorqueSensorServiceProvided(ITorqueSensorService *fn)
	{
		pcom = fn;
	...
	virtual void setup()
	{
		...
		ptr_method = makeProvidedMethod(&ITorqueSensorService::SetParameter,pcom,"SetParameter");
		opros_assert(ptr_method != NULL);
		addMethod("SetParameter",ptr_method);
		SetParameterFunc = reinterpret_cast<SetParameterFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITorqueSensorService::GetParameter,pcom,"GetParameter");
		opros_assert(ptr_method != NULL);
		addMethod("GetParameter",ptr_method);
		GetParameterFunc = reinterpret_cast<GetParameterFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITorqueSensorService::GetError,pcom,"GetError");
		opros_assert(ptr_method != NULL);
		addMethod("GetError",ptr_method);
		GetErrorFunc = reinterpret_cast<GetErrorFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITorqueSensorService::Enable,pcom,"Enable");
		opros_assert(ptr_method != NULL);
		addMethod("Enable",ptr_method);
		EnableFunc = reinterpret_cast<EnableFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITorqueSensorService::Disable,pcom,"Disable");
		opros_assert(ptr_method != NULL);
		addMethod("Disable",ptr_method);
		DisableFunc = reinterpret_cast<DisableFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITorqueSensorService::GetSensorValue,pcom,"GetSensorValue");
		opros_assert(ptr_method != NULL);
