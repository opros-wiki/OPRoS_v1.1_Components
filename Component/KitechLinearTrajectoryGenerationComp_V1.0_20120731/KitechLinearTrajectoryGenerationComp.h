#ifndef _KitechLinearTrajectoryGenerationComp_COMPONENT_H
#define _KitechLinearTrajectoryGenerationComp_COMPONENT_H
/*
...
class KitechLinearTrajectoryGenerationComp : public Component, public ITrajectoryGenerationService
{
protected:
...
public:
	KitechLinearTrajectoryGenerationComp();
	KitechLinearTrajectoryGenerationComp(const std::string &compId);
	virtual ~KitechLinearTrajectoryGenerationComp();
