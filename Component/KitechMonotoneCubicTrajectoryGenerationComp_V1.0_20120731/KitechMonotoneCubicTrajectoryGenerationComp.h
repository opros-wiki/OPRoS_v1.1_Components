#ifndef _KitechMonotoneCubicTrajectoryGenerationComp_COMPONENT_H
#define _KitechMonotoneCubicTrajectoryGenerationComp_COMPONENT_H
/*
...
class KitechMonotoneCubicTrajectoryGenerationComp : public Component, public ITrajectoryGenerationService
{
protected:
...
public:
	KitechMonotoneCubicTrajectoryGenerationComp();
	KitechMonotoneCubicTrajectoryGenerationComp(const std::string &compId);
	virtual ~KitechMonotoneCubicTrajectoryGenerationComp();
