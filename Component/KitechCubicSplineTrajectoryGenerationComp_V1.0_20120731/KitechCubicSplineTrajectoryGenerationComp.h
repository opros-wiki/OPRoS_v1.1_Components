#ifndef _KitechCubicSplineTrajectoryGenerationComp_COMPONENT_H
#define _KitechCubicSplineTrajectoryGenerationComp_COMPONENT_H
/*
...
class KitechCubicSplineTrajectoryGenerationComp : public Component, public ITrajectoryGenerationService
{
protected:
...
public:
	KitechCubicSplineTrajectoryGenerationComp();
	KitechCubicSplineTrajectoryGenerationComp(const std::string &compId);
	virtual ~KitechCubicSplineTrajectoryGenerationComp();
