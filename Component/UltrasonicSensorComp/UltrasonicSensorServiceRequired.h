...
public:
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeRequiredMethod(&UltrasonicSensorServiceRequired::Enable,"Enable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&UltrasonicSensorServiceRequired::Disable,"Disable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&UltrasonicSensorServiceRequired::GetSensorValue,"GetSensorValue");
        opros_assert(ptr_method != NULL);
