...
#ifndef _IAccelerationSensorService_CLASS_DEF
#define _IAccelerationSensorService_CLASS_DEF
/*
...
public:
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeProvidedMethod(&IAccelerationSensorService::Enable,pcom,"Enable");
        ...
        ptr_method = makeProvidedMethod(&IAccelerationSensorService::Disable,pcom,"Disable");
        ...
        ptr_method = makeProvidedMethod(&IAccelerationSensorService::GetSensorValue,pcom,"GetSensorValue");
