...
#ifndef _GlobalPositioningSystemService_REQUIRED_PORT_H
#define _GlobalPositioningSystemService_REQUIRED_PORT_H
...
/*
 * 
 * GlobalPositioningSystemService : public RequiredServicePort
 *
 */
class GlobalPositioningSystemServiceRequired
...
protected:
	...
	typedef RequiredMethod< vector<GpsData> > GetSensorValueFuncType;
...
public:
	...
	// Constructor
	//
	GlobalPositioningSystemServiceRequired()
	{
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeRequiredMethod(&GlobalPositioningSystemServiceRequired::SetParameter,"SetParameter");
        ...
        ptr_method = makeRequiredMethod(&GlobalPositioningSystemServiceRequired::GetParameter,"GetParameter");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&GlobalPositioningSystemServiceRequired::GetError,"GetError");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&GlobalPositioningSystemServiceRequired::Enable,"Enable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&GlobalPositioningSystemServiceRequired::Disable,"Disable");
        opros_assert(ptr_method != NULL);
        ...
        ptr_method = makeRequiredMethod(&GlobalPositioningSystemServiceRequired::GetSensorValue,"GetSensorValue");
        opros_assert(ptr_method != NULL);
