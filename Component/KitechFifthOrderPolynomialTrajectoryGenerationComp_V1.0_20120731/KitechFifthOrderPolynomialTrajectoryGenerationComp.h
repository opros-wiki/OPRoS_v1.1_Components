#ifndef _KitechFifthOrderPolynomialTrajectoryGenerationComp_COMPONENT_H
#define _KitechFifthOrderPolynomialTrajectoryGenerationComp_COMPONENT_H
/*
...
class KitechFifthOrderPolynomialTrajectoryGenerationComp : public Component, public ITrajectoryGenerationService
{
protected:
	//	Service Port
...
public:
	KitechFifthOrderPolynomialTrajectoryGenerationComp();
	KitechFifthOrderPolynomialTrajectoryGenerationComp(const std::string &compId);
	virtual ~KitechFifthOrderPolynomialTrajectoryGenerationComp();
