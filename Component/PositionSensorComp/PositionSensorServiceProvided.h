...
#ifndef _IPositionSensorService_CLASS_DEF
#define _IPositionSensorService_CLASS_DEF
/*
...
class IPositionSensorService
{
 public:
    ...
    virtual vector<ObjectPosition> GetSensorValue()=0;
 };
#endif
 ...
 *
 */
class PositionSensorServiceProvided
	:public ProvidedServicePort, public IPositionSensorService
{
protected:
   ...
   typedef ProvidedMethod< vector<ObjectPosition> > GetSensorValueFuncType;
...
public:
    ...
    virtual void setup()
    {
        ...
        ptr_method = makeProvidedMethod(&IPositionSensorService::Enable,pcom,"Enable");
        ...
        ptr_method = makeProvidedMethod(&IPositionSensorService::Disable,pcom,"Disable");
        ...
        ptr_method = makeProvidedMethod(&IPositionSensorService::GetSensorValue,pcom,"GetSensorValue");
