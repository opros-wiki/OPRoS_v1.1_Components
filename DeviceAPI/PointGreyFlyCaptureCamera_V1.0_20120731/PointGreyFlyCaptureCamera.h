...
/**
 *	PointGreyFlyCaptureCamera
 *	PointGrey에서 제작한 FlyCapture 카메라 장치를 제어합니다.
 */
class PointGreyFlyCaptureCamera : public Camera
{
public:
	PointGreyFlyCaptureCamera(void);
	virtual ~PointGreyFlyCaptureCamera(void);
